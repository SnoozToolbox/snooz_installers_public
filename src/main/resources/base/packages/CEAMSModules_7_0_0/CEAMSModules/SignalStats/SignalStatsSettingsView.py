...
See the file LICENCE for full license details.
    ...
    Settings viewer of the SignalStats plugin
"""

from qtpy import QtWidgets

from CEAMSModules.SignalStats.Ui_SignalStatsSettingsView import Ui_SignalStatsSettingsView
from commons.BaseSettingsView import BaseSettingsView

class SignalStatsSettingsView(BaseSettingsView, Ui_SignalStatsSettingsView, QtWidgets.QWidget):
    """
        SignalStatsView set the SignalStats settings
    """
    ...
    def on_apply_settings(self):
        ...
        """
        # Send the settings to the publisher for inputs to SignalStats
