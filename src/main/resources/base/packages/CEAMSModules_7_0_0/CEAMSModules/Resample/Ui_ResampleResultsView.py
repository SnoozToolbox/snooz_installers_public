...
class Ui_ResampleResultsView(object):
    def setupUi(self, ResampleResultsView):
        if not ResampleResultsView.objectName():
            ResampleResultsView.setObjectName(u"ResampleResultsView")
        ResampleResultsView.resize(927, 262)
        self.verticalLayout = QVBoxLayout(ResampleResultsView)
        ...
        QMetaObject.connectSlotsByName(ResampleResultsView)
    # setupUi

    def retranslateUi(self, ResampleResultsView):
        ResampleResultsView.setWindowTitle(QCoreApplication.translate("ResampleResultsView", u"Form", None))
    # retranslateUi
